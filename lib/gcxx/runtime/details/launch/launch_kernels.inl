...
namespace launch {
  ...
  GCXX_FH()
  void CooperativeKernel(LaunchConfig& config, void (*kernel)(ExpTypes...),
                         ActTypes&&... args) {
  ...
  template <typename... ExpTypes, typename... ActTypes>
  GCXX_FH()
  void Kernel(dim3 griddim, dim3 blockdim, void (*kernel)(ExpTypes...),
              ActTypes&&... args) {
  ...
  template <typename... ExpTypes, typename... ActTypes>
  GCXX_FH()
  void Kernel(StreamView sv, dim3 griddim, dim3 blockdim,
