...
class linear_storage {
 ...
 public:
  ...
  GCXX_HD void swap(linear_storage& other) {
    ...
    //   is true, then allocator_type shall meet the Cpp17Swappable requirements
    //   and the allocators of a and b shall also be exchanged by calling swap
    ...
    if constexpr (alloc_traits::propagate_on_container_swap::value) {
      ...
      //   NV_IF_TARGET(NV_IS_DEVICE, (assert(m_allocator ==
      //   other.m_allocator);), (if (m_allocator != other.m_allocator) {
